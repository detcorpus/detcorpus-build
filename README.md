---
author: К. Маслинский, Е. Лекаревич, Л. Алейник, А. Колотовкина
title: Корпус русской прозы для детей и юношества
abstract: "ДетКорпус — это аннотированный корпус русской детской литературы, который отражает литературный процесс XX—XXI в. Корпус создан в первую очередь как инструмент для исторических, типологических и количественных исследований в области детской литературы, но открыт и для любых пользовательских задач. Онлайн-интерфейс для поиска по корпусу свободно доступен для исследователей, библиотекарей, учителей, и всех интересующихся детской литературой по адресу detcorpus.ru. Деткорпус включает около 4000 прозаических произведений, написанных на русском языке в период с 1870-х по 2020-е годы и адресованных детям и подросткам. Корпус делится на две части: подкорпус художественной литературы произведений и подкорпус нон-фикшен. Подробное описание структуры датасета содержится в файле README.md"
---

> Формат цитирования датасета:
> *Маслинский, Кирилл; Лекаревич, Евгения; Алейник, Любовь; Колотовкина, Анна* 
> Корпус русской прозы для детей и юношества //
> Репозиторий открытых данных по русской литературе и фольклору. 2021. 
> V4. DOI: https://doi.org/10.31860/openlit-2021.4-C001
...
Деткорпус включает прозаические произведения, написанные на
...
литературы (3808 произведений) и подкорпус нон-фикшн (273). В корпус
...
Таблица **metadata.csv** содержит следующие колонки:
...
инфраструктуры корпуса. Курированием данных Деткорпуса занимаются
сотрудники Лаборатории цифровых исследований литературы и фольклора
ИРЛИ (Пушкинский Дом) РАН и другие наши коллеги. 

 * Анна Колотовкина — куратор данных Деткорпуса, занимается
   пополнением корпуса, уточнением метаданных, исправлением ошибок.
 * Елена Казакова — куратор подкорпуса нон-фикшн, собирает и готовит к
   публикации тексты научно-популярной детской литературы.
 * Ринат Бакиров — куратор поэтического подкорпуса, занимается
   подбором и подготовкой стихотворных текстов для корпуса, включая
   стиховедческую разметку.
 ...
 * Евгения Лекаревич — первый куратор данных Деткорпуса, лучше всех
   знает внутреннюю структуру данных и их историю и продолжает
   заботиться о полноте и корректности данных корпуса.
 * Любовь Алейник — главный библиограф корпуса, составила
   первоначальное «ядро» коллекции и сформировала постсоветский
   корпус. Осуществляет текущую библиографическую поддержку и
   консультирование.
...
### Верися V4, 2026-03-12

- Обновление корпуса в основном включает в себя произведения из
  изданий 1920—1930х гг., цифровые копии которых были предоставлены
  Российской государственной детской библиотекой. Также добавлены
  издания последующих десятилетий (1940е — 2020е).
- Важная часть обновления — новый раннесоветский «нонфикшн» —
  познавательная литература для детей и подростков (энциклопедии,
  естественнонаучные, исторические и общеобразовательные повести и
  рассказы).
- В корпусе исправлены ошибки, улучшена система жанровых тегов.

### Версия V3, 2023-12-29

- Подкорпус художественной прозы пополнен произведениями 1920—1930-х годов, некоторыми произведениями 
  конца XIX в., а также рядом современных произведений 2010-х — начала 2020-х годов. Всего в корпусе
  3281 произведение более чем 1000 авторов. 
- Подкорпус нон-фикшен пополнен произведениями 1920—1930-х, его объем достиг 196 произведений. 
- Исправлены замеченные ошибки в данных и в метаданных произведений. 

### Версия V2, 2022-04-08
